...
import case_study.servie.ICustomerService;
...
public class CustomerServiceImp extends Customer implements ICustomerService {
    ...
    public CustomerServiceImp(int id,
                              String name,
                              String dayOfBirth,
                              String gender,
                              String soCmnd,
    ...
    public CustomerServiceImp(String typeOfCustomer, String address) {
    ...
    static {
        Customer employee = new Customer(1, "dương", "1993", "nam", "0231321", "013213", "asdasd@gmail.com", "Silver", "đà nẵng");
        Customer employee1 = new Customer(1, "minh", "1993", "nam", "0231321", "013213", "asdasd@gmail.com", "Silver", "đà nẵng");
        Customer employee2 = new Customer(1, "nguyệt", "1993", "nữ", "0231321", "013213", "asdasd@gmail.com", "Silver", "đà nẵng");
    ...
    public void displayListService() {
        customerList = read("E:\\Code Gym\\Module 1\\Github\\Module2\\src\\data\\customer.csv");
    ...
    public void addNew() {
        ...
        CustomerServiceImp newCustomer = new CustomerServiceImp(id, name, dayOfBirth, gender, soCmnd, phoneNumber, email, typeOfCustomer, address);
        customerList.add(newCustomer);
        write("E:\\Code Gym\\Module 1\\Github\\Module2\\src\\data\\customer.csv");
