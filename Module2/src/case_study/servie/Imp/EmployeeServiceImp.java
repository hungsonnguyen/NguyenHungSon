...
import case_study.servie.IEmployeeService;
...
public class EmployeeServiceImp extends Employee implements IEmployeeService {
    ...
    static {
        Employee employee = new Employee(1, "nguyen", "1993", "nam", "0231321", "013213", "asdasd@gmail.com", "aasdasd", "tạp vụ", 2121);
        employeeList.add(employee);

    }


    public EmployeeServiceImp(int id,
                              String name,
                              String dayOfBirth,
                              String gender,
                              String soCmnd,
    ...
    public EmployeeServiceImp(String prof, String level, int payment) {
    ...
    public void displayListService() {
        employeeList = read("E:\\Code Gym\\Module 1\\Github\\Module2\\src\\data\\employee.csv");
...
//        int payment = Integer.parseInt((scanner.nextLine()));
        ...
        employeeList.add(employee);
        write("E:\\Code Gym\\Module 1\\Github\\Module2\\src\\data\\employee.csv");
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.getName() == otherStudent.getName()){
            return true;
        }
        return false;
    }
