...
public class Attach_service {
    ...
    public Attach_service(String attach_service_id, String attach_service_name, double attach_service_cost, int attach_service_unit, String attach_service_status) {
