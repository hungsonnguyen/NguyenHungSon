...
public class ProductRepositoryImpl implements ProductRepository {
    ...
    private static String INSERT_PRODUCT = "INSERT INTO `demo_exam`.`product` (`product_name`, `product_price`, `product_quanity`, `category_id`, `color_id`) VALUES (?, ?, ?, ?, ?);";
    private static String DELETE_PRODUCT = "delete from product where product_id = ?";
    private static String EDIT_PRODUCT = "UPDATE `demo_exam`.`product` SET `product_name` = ?, `product_price` = ?, `product_quanity` = ?, `category_id` = ?, `color_id` = ? WHERE (`product_id` = ?);\n";
    ...
    public Product selectProductById(int id) {
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            while (resultSet.next()) {
                ...
                product = new Product(product_id, product_name, product_price, product_quanity, color_id, color_name, category_id, category_name);
    ...
    public void insert(Product product) {
        ...
        if (connection != null) {
            try {
                ...
                preparedStatement.setInt(5, product.getColorId());
        ...
        if (connection != null) {
            try {
                ...
                while (resultSet.next()) {
                    ...
                    int category_id = resultSet.getInt("category_id");
                    String category_name = resultSet.getString("category_name");
                    productList.add(new Product(product_id, product_name, product_price, product_quanity, color_id, color_name, category_id, category_name));
        ...
        if (connection != null) {
            ...
            try {
                ...
                while (resultSet.next()) {
                    ...
                    int category_id = resultSet.getInt("category_id");
                    String category_name = resultSet.getString("category_name");
                    productList.add(new Product(product_id, product_name, product_price, product_quanity, category_id, category_name, color_id, color_name));
