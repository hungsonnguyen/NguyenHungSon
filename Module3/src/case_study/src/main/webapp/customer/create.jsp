        ...
        <div class="col-9">
            <form action="/customer?action=create" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="id-card-customer" name="id-card-customer">
                </div>
                <div class="form-group">
                    <label for="phone-customer">Phone</label>
                    <input class="form-control" id="phone-customer" name="id-card-customer">
                </div><div class="form-group">
                    <label for="email">Email</label>
                    <input class="form-control" id="email" name="email-customer">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="address-customer" name="address-customer">
                </div>
