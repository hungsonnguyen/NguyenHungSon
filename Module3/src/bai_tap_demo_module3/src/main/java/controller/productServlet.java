...
public class productServlet extends HttpServlet {
    ...
    private void searchProductByName(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<Product> productList = productService.selectCustomer(searchName);
        request.setAttribute("customerList", productList);
    ...
    private void editProduct(HttpServletRequest request, HttpServletResponse response) {
        ...
        Product product = new Product(productId, productName, product_price, productQuanity, categoryId, colorId);
        RequestDispatcher dispatcher;
        if (product == null) {
            dispatcher = request.getRequestDispatcher("error-404.jsp");
        } else {
    ...
    private void createProduct(HttpServletRequest request, HttpServletResponse response) {
        ...
        int categoryId = Integer.parseInt(request.getParameter("colorProduct"));
        int colorId = Integer.parseInt(request.getParameter("category"));

        Product product = new Product( productName, product_price, productQuanity, categoryId, colorId);
